...
interface PreviewSwiperCoverflowProps {
  paginationKey: string;
  paginationArr: PaginationAttr[];
  swiperAttr: SwiperAttr;
  swiperGetKey: (e) => void;
}
interface PreviewSwiperCoverflowState {}

class PreviewSwiperCoverflow extends react.Component<
  PreviewSwiperCoverflowProps,
  PreviewSwiperCoverflowState
> {
  private swiper: any;
  constructor(prop: PreviewSwiperCoverflowProps) {
    super(prop);
    this.state = {};
  }
...
export default PreviewSwiperCoverflow;
