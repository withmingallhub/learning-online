...
interface PreviewSwiperFadeProps {
  paginationArr: PaginationAttr[];
  swiperAttr: SwiperAttr;
  swiperGetKey: (e) => void;
}
interface PreviewSwiperFadeState {}

class PreviewSwiperFade extends react.Component<
  PreviewSwiperFadeProps,
  PreviewSwiperFadeState
> {
  private swiper: any;
  constructor(prop: PreviewSwiperFadeProps) {
    super(prop);
    this.state = {};
  }
...
export default PreviewSwiperFade;
