      ...
      <div>
        ...
        >
          <div className="start_control">
            ...
            <Button
              disabled={this.state.isRecorder ? false : true}
          ...
          <div className="recordering">
            <img
              src={recorderImage}
              alt=""
              style={{ borderRadius: "19px", height: "100px" }}
            />
            <img
              src={recorderImage}
              alt=""
          ...
          {this.state.RecorderSuccess && (
            ...
            >
              <Audio
                audioType={
                  this.recorder.getWAVBlob() ? this.recorder.getWAVBlob() : null
                }
              />
              <div style={{ width: "100%" }}>
                <Button
